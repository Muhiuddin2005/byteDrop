...
const SendParcel = () => {
                ...
                axiosSecure.post('/parcels', data)
                    .then(res => {
                        if (res.data.insertedId) {
                            ...
                            Swal.fire({
                                icon: "success",
                                title: "Parcel has been created. Please complete payment.",
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(handleSendParcel)} className='mt-12 p-4 text-base-content'>
                {/* parcel type*/}
                <div>
                ...
                <input type="submit" className='btn btn-primary mt-8 text-primary-content' value="Send Parcel" />
            </form>
        </div>
    );
};
