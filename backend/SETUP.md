...
- `http://localhost:3000/` - Should return "Bytedrop server is running!"
...
- Make sure you have the Firebase Admin SDK JSON file (`bytedrop-firebase-adminsdk.json`) if you're using it directly (though the code uses base64 encoded version)
